...
void *connection_handler(void *threadid)
{
    ...
    if( bind(base_Station_Socket_handler,(struct sockaddr *)&serv_addr , sizeof(serv_addr)) < 0)
    {
    ...
    listen(base_Station_Socket_handler , 3);
    ...
    acc_soc = accept(base_Station_Socket_handler, (struct sockaddr *)&serv_addr, (socklen_t*)&c);
    ...
    while(1)
    {
        ...
        int stat = write(acc_soc,buffer,72);
        ...
        int rc  = read(acc_soc,buffer_rcv,256);
        printf("%s\n",buffer_rcv);
